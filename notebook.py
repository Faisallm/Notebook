...
class Notebook:
    ...
    def modify_tags(self, note_id, tags):
        """Find the note with the given id and change its tags to
        the given value."""
        note = self._find_note(note_id)
        if note:
            note.tags = tags
    ...
    def search(self, filter):
        """Find all notes that match the given id and change its
        tags to the given value"""

        # this technique below is known as list comprehension
